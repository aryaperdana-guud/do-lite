    ...
    <div className="dashboard">
      ...
      <main className="main-content">
        ...
        <div className="do-header">
          <div className="do-title-container">
        ...
        <div className="form">
          ...
          <div className="tabs-container">
            <Tabs
              aria-label="DO Detail Tabs"
              defaultValue={0}
              sx={{ backgroundColor: "transparent" }}
            >
              <TabList className="tab-list">
                <Tab className="tab-item tab-active">GENERAL DETAILS</Tab>
                <Tab className="tab-item">INVOICES</Tab>
                <Tab className="tab-item tab-with-icon">TAX INVOICES</Tab>
                <Tab className="tab-item">CONTAINERS</Tab>
                <Tab className="tab-item">EXTENSIONS</Tab>
              </TabList>
            </Tabs>
          </div>
          ...
          <div className="cards-container">
            <div className="left-group">
              ...
              <div className="general-details">
                ...
                <div className="bill-loading-section">
                  <div className="details-title">
                    <svg
                      width="20"
                      height="20"
